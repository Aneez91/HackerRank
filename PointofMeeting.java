...
public class PointofMeeting {
	 public static void main(String[] args) {
	      ...
	      int best = 0;
	       double best_dist=Math.sqrt( Math.pow(diff_x, 2)+Math.pow( diff_y,2));
	      double hold_dist;
	      ...
	      for(i=1; i<num; ++i)
	      {
	         ...
	         diff_y = points[i].y - ave_y;
	            hold_dist=Math.sqrt( Math.pow(diff_x, 2)+Math.pow( diff_y,2));
	      ...
	      for(i=0; i<num; ++i)
	      {
	         ...
	         total_dist+=Math.sqrt( Math.pow(diff_x, 2)+Math.pow( diff_y,2));
	       }
